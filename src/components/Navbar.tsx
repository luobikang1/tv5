      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            {currentUser && (
              <div className="hidden sm:flex items-center space-x-1 px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-300">
                <User className="w-3.5 h-3.5 text-fox-500" />
            ...
            {currentUser ? (
              <button
                onClick={logout}
                className="p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-red-50 dark:hover:bg-red-950/30 hover:text-red-500 transition-colors"
                title="退出登录"
              >
